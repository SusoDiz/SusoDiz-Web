document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateSvgFill(mode) {
        ...
        document.body.querySelector('.logo-github').setAttribute('fill', fillColor);
        document.body.querySelector('.logo-twitter').setAttribute('fill', fillColor);
        document.body.querySelector('.logo-email').setAttribute('fill', fillColor);
    }
